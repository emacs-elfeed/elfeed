...
EL   = elfeed-csv.el elfeed-curl.el elfeed-db.el	\
       elfeed-lib.el elfeed-log.el elfeed-show.el elfeed.el			\
       xml-query.el elfeed-search.el elfeed-tree.el elfeed-link.el
